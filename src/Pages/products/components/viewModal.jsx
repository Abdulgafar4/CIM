        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Descriptions.Item label="Product Name">{record.name}</Descriptions.Item>
                    ...
                    <Descriptions.Item label="Date Added">{record.date}</Descriptions.Item>
                    <Descriptions.Item label="Description">{record.desc}</Descriptions.Item>
                </Descriptions>
            </Modal>
        </>
    );
